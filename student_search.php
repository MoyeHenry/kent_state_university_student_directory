...
<body><br>
<p><h2> Kent State University Student Directory Search </h2></p>
<form action="student_search.php" method="POST" autocomplete="off">
...
{
    echo "Please enter a Student name and Submit.";
}
else {
// Create connection
    ...
    if (!empty($_POST["name"]))
    {
        ...
        $sqlstatement = $conn->prepare("SELECT id, name, dept_name, tot_cred FROM student WHERE name LIKE '%$studentName%'");
